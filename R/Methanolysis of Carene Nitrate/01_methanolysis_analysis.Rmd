...
```{r, message=FALSE}
methanolysis_data <- read_csv("/Users/jamesvesto/R-Studio Files/Projects/terpene-kinetics/data/RKL-04-35zg2d.csv")
...
mplt <- ggplot(methanolysis, aes(time_s,integral_mM,color=assignment))+
  ...
  labs(x="Time (s)", 
       y="Concentration (mM)", 
       title="Trial #1 Carene Nitrate Methanolysis: RKL-04-35")+
  theme_bw()+ 
  ...
  annotation_raster(raster,2000, 4000,.40, 0.759)+
...
```{r}
save_plot("/Users/jamesvesto/R-Studio Files/Projects/terpene-kinetics/images/plots/RKL-04-35zg2d.jpg", mplt)
rm(list=ls()) 
```
